...
currentElective = 'CS4067-DevOps'
targetElectives = [('SE4031-Design Defects and Restructuring',"1968")]
c_id = "1874"
refreshRate = 1
...
#identify text box
l = driver.find_element(by=By.NAME, value='username')
l.send_keys("19K-0311")
l.send_keys(Keys.RETURN)

l = driver.find_element(by=By.NAME, value='password')
l.send_keys("4287871597")
l.send_keys(Keys.RETURN)


l=driver.find_element(by=By.CLASS_NAME, value='g-recaptcha')
l.click()

sleep(10)

l = driver.find_element_by_id('m_login_signin_submit')
l.click()
...
while(1):
    ...
    l = driver.find_element_by_link_text("Home").click()
    #l = driver.find_element(by=By.CLASS_NAME,value="m-menu__link-icon la la-home").click()
    # sleep(refreshRate)
    l = driver.find_element_by_link_text("Course Registration").click()
    sleep(refreshRate)
